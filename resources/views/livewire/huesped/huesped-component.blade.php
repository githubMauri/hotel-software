                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                            aria-current="page">Huesped</li>
                    </ol>
                    <h6 class="mb-0 font-bold capitalize">Huesped</h6>
                </nav>
                ...
                <div class="flex-none w-full max-w-full px-3">
                    <div
                        ...
                        <div
                            ...
                            <h6>Registro del Huesped</h6>
                            <!--Register btn  -->
                            <a href="{{ route('huesped') }}"
                            ...
                            cursor-pointer border-0 bg-transparent px-8 py-2 text-center align-middle font-bold uppercase text-white transition-all">Registro
                                de Huesped</a>
                            ...
                            <!--   <a class="inline-block px-8 py-2 mb-0 mr-4 font-bold text-center uppercase align-middle transition-all bg-transparent 
                                ...
                                href="{{ route('registro_empleado') }}">Registrar huesped</a> -->
                            </li>
                            <!--Register btn fin -->
                        </div>
                                        ...
                                        @foreach ($huesped as $huesped)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <span
                                                        class="mb-0 font-semibold leading-tight text-xs">{{ $huesped->apellido }}</span>
                                                </td>

                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap shadow-transparent">
                                                    <span
                                                        class="mb-0 font-semibold leading-tight text-xs">{{ $huesped->ci }}</span>
                                                </td>

                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap shadow-transparent">
                                                    <span
                                                        class="mb-0 font-semibold leading-tight text-xs">{{ $huesped->direccion }}</span>
                                                </td>

                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap shadow-transparent">
                                                    <span
                                                        class="mb-0 font-semibold leading-tight text-xs">{{ $huesped->telefono }}</span>
                                                </td>

                                                <td
                                                    class="p-2 leading-normal text-center align-middle bg-transparent border-b text-sm whitespace-nowrap shadow-transparent">
                                                    <span
                                                        class="mb-0 font-semibold leading-tight text-xs">{{ $huesped->correo }}</span>
                                                </td>
