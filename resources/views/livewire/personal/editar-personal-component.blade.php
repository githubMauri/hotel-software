                    ...
                    <nav>
                        ...
                        <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                            ...
                            <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']"
                                aria-current="page">Personal / Actulizar</li>
                        </ol>
                        <h6 class="mb-0 py-6 font-bold capitalize">Editar Personal</h6>
                    </nav>
                        ...
                        <div class="flex-none w-full max-w-full px-3">
                            <div
                                ...
                                @if (Session::has('message'))
                                    <div class="alert alert-success font-bold py-6 leading-tight text-left text-slate-500"
                                ...
                                <div class="flex-auto p-6">
                                    <form wire:submit.prevent="updateEmpleado">
                                            ...
                                            <div class="w-full max-w-full px-3 shrink-0 md:w-6/12 md:flex-0">
                                                <div class="mb-4">
                                                    <label for="apellido_paterno"
                                                        ...
                                                        paterno</label>
                                                    <input type="text" name="first apellido_paterno"
                                                        value="Jesse"
                                                        class="focus:shadow-primary-outline dark:bg-slate-850 dark:text-white text-sm leading-5.6 ease block w-full 
                                        ...
                                        <p class="leading-normal uppercase dark:text-white dark:opacity-60 text-sm">a
                                            puro
                                            lapiz y papel
                                        </p>
                                        <a type="submit"
